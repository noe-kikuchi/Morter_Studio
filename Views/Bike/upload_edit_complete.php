...
<?php else : ?>
  ...
  <!-- <script type='text/javascript'>location.href = './edit.php?id=<?php echo $_POST["id"];?>';</script> -->
<?php endif;?> 


<!-- <script type='text/javascript'>location.href = "javascript:history.back();"</script> -->
